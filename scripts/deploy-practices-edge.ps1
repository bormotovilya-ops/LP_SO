...
Write-Host "[1/3] practices-channel-invite (no JWT)" -ForegroundColor Yellow
Invoke-SupabaseCli @(
...
Write-Host "[2/3] telegram-webhook (no JWT)" -ForegroundColor Yellow
Invoke-SupabaseCli @(
...
Write-Host "[3/3] payment-init" -ForegroundColor Yellow
Invoke-SupabaseCli @(
