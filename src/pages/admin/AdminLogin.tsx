      ...
      <div className="container-luxe flex min-h-screen flex-col items-center justify-center py-16">
        <div className="w-full max-w-sm space-y-8 rounded-sm border border-hairline bg-surface/30 p-8 shadow-sm">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Авторизация команды</p>
          </div>
          {/* Временно отключено: регистрация и восстановление по email-ссылкам. */}
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">Пользователи CRM добавляются администратором вручную.</p>
          </form>
